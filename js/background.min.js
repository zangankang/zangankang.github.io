!(function () {
  ...
  for (var c = 0; c < t; c++)
    a.push({ x: 0, y: 0, z: 0.2 + 0.8 * Math.random() });
  m(),
    (function t() {
      e.clearRect(0, 0, i, r),
        (y.tx *= 0.95),
            ...
            (t.x < -50 || t.x > i + 50 || t.y < -50 || t.y > r + 50) &&
              ...
              1 < a &&
                ...
                (n =
                  "h" ==
                  (e < a
                    ? Math.random() < Math.abs(y.x) / (a + e)
                      ? "h"
                      : "v"
                    : Math.random() < Math.abs(y.y) / (a + e)
                    ? "v"
                    : "h")
                    ? 0 < y.x
                      ? "l"
              ...
              "z" === n
                ? ((t.z = 0.1),
                  ...
                  (t.y = Math.random() * r))
                : "l" === n
                ? ((t.x = -3), (t.y = r * Math.random()))
                : "r" === n
                ? ((t.x = i + 3), (t.y = r * Math.random()))
                : "t" === n
                ? ((t.x = i * Math.random()), (t.y = -3))
                : "b" === n && ((t.x = i * Math.random()), (t.y = r + 3)));
        }),
        a.forEach(function (t) {
          e.beginPath(),
            (e.lineCap = "round"),
